...
unchecked = WebUI.verifyElementNotChecked(findTestObject(''), 0)
...
WebUI.verifyElementChecked(findTestObject(''), 0)

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/td_24'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_comment'), 'dr')
